    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <form method="POST" action="{{ route('login') }}">
                @csrf <div class="mb-3 text-start">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="username" value="{{ old('username') }}" class="form-control" required placeholder="user" autocomplete="off">
                    </div>
                </div>
            ...
            <div class="footer-text">
                &copy; {{ date('Y') }} بيت المحاسبة. جميع الحقوق محفوظة.
            </div>
        </div>
    </div>
