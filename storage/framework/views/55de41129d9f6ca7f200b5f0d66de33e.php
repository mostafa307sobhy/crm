...
<?php $__env->startSection('title', $isWorkspace ? 'مساحة العمل الداخلية' : 'ملف العميل: ' . $client->name); ?>
...
<div class="crm-header mb-4 <?php echo e($isWorkspace ? 'workspace-header' : ''); ?> shadow">
        ...
        <div class="d-flex align-items-center gap-3">
            <div>
                <h3 class="mb-0 fw-bold d-flex align-items-center">
                    ...
                    <?php else: ?>
                        <div class="bg-white bg-opacity-10 p-2 rounded-3 me-3"><i class="fas fa-building text-warning"></i></div> <?php echo e($client->name); ?>
            ...
            <?php if(!$isWorkspace): ?>
            <div class="ms-lg-4">
                <span class="badge <?php echo e($curr_badge['class']); ?> rounded-pill px-4 py-2 fs-6 shadow-sm border border-white border-opacity-25"><?php echo e($curr_badge['text']); ?></span>
            </div>
            <?php endif; ?>
        </div>
        <div>
            <a href="<?php echo e(route('clients.index')); ?>" class="btn btn-light rounded-pill px-4 fw-bold shadow-sm text-primary">
...
<div class="tab-content" id="clientTabsContent">
    ...
    <div class="tab-pane fade show active" id="overview" role="tabpanel">
        <div class="row g-4">
            ...
            <?php if($isAdminAuth && !$isWorkspace): ?>
            <div class="col-lg-6">
                <div class="custom-card h-100 border-top border-primary border-4">
                    <div class="card-body p-0">
                        <div class="p-4 bg-light text-center border-bottom">
                            ...
                            <h3 class="fw-bold text-success mb-0"><?php echo e($client->subscription_amount ? number_format($client->subscription_amount, 2) . ' ريال' : 'غير محدد'); ?></h3>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center py-3 px-4">
                                ...
                                <span class="fw-bold text-dark"><?php echo e($client_package); ?></span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center py-3 px-4">
                                ...
                                <span class="fw-bold text-dark"><?php echo e($client->tax_number ?: '---'); ?></span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center py-3 px-4">
                                ...
                                <span class="fw-bold text-dark"><?php echo e($client->commercial_register ?: '---'); ?></span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center py-3 px-4">
                                ...
                                <span class="fw-bold text-dark" dir="ltr"><?php echo e($client->sub_start_date ?? '---'); ?></span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center py-3 px-4">
                                ...
                                <span class="fw-bold text-danger" dir="ltr"><?php echo e($client->sub_end_date ?? '---'); ?></span>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="<?php echo e($isAdminAuth && !$isWorkspace ? 'col-lg-6' : 'col-12'); ?>">
                
                <?php
                    $visibleNotes = $isAdminAuth ? $clientNotes : $clientNotes->where('type', 'alert');
                ?>

                <?php if($visibleNotes->count() > 0 || $isAdminAuth): ?> <div class="custom-card mb-4 border-top border-info border-4">
                    <div class="custom-card-header d-flex justify-content-between align-items-center py-3">
                        <h6 class="fw-bold mb-0 text-info"><i class="fas fa-exclamation-circle me-2"></i> <?php echo e($isAdminAuth ? 'ملاحظات وتنبيهات' : 'تنبيهات هامة'); ?></h6>
                        <?php if($isAdminAuth): ?>
                    ...
                    <div class="card-body p-3" style="max-height: 250px; overflow-y: auto;">
                        <?php $__empty_1 = true; $__currentLoopData = $visibleNotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php 
                            ...
                            ?>
                            <div class="p-3 mb-2 rounded-4 <?php echo e($bg); ?> shadow-sm">
                                <div class="d-flex justify-content-between align-items-center mb-1">
                                    <strong class="small fw-bold"><i class="fas <?php echo e($icon); ?> me-1"></i> <?php echo e($title); ?></strong>
                                    <div class="d-flex align-items-center gap-2">
                                        <small class="<?php echo e($isAlert ? 'text-white-50' : 'text-muted'); ?>" style="font-size:0.7rem;"><?php echo e($note->user->username ?? '---'); ?></small>
                                        <?php if($isAdminAuth): ?>
                                        <button type="button" onclick="openEditNoteModal(<?php echo e($note->id); ?>, '<?php echo e($note->type); ?>', `<?php echo e(htmlspecialchars($note->content, ENT_QUOTES)); ?>`)" class="btn btn-sm p-0 text-<?php echo e($isAlert ? 'white' : 'primary'); ?> hover-zoom" title="تعديل"><i class="fas fa-edit"></i></button>
                                        <form action="<?php echo e(route('notes.destroy', $note->id)); ?>" method="POST" class="m-0 p-0 d-inline">
                                            <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                            <button type="button" class="btn btn-sm p-0 text-<?php echo e($isAlert ? 'white' : 'danger'); ?> hover-zoom" onclick="return confirmAction(event, this.closest('form'), 'سيتم حذف هذه الملاحظة نهائياً؟')" title="حذف"><i class="fas fa-trash-alt"></i></button>
                                        </form>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <p class="mb-0 small" style="line-height: 1.6;"><?php echo nl2br(e($note->content)); ?></p>
                            </div>
                ...
                <div class="custom-card border-top border-warning border-4">
                    ...
                    <div class="card-body p-3" style="max-height: 250px; overflow-y: auto;">
                        <?php $__empty_1 = true; $__currentLoopData = $client->contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="bg-light p-3 rounded-4 border border-warning border-opacity-25 mb-2 d-flex justify-content-between align-items-center">
                                <div>
                                    <span class="d-block fw-bold text-dark small"><?php echo e($contact->name); ?> <span class="badge bg-white text-muted border ms-1"><?php echo e($contact->job_title); ?></span></span>
                                    <small class="text-muted fw-bold d-block mt-1" dir="ltr"><?php echo e($contact->phone); ?></small>
                                </div>
                                <div class="d-flex align-items-center gap-2">
                                    <a href="tel:<?php echo e($contact->phone); ?>" class="btn btn-sm btn-success rounded-circle shadow-sm d-flex align-items-center justify-content-center" style="width:32px; height:32px;"><i class="fas fa-phone-alt"></i></a>
                                    <button type="button" onclick="openEditContactModal(<?php echo e($contact->id); ?>, `<?php echo e(htmlspecialchars($contact->name, ENT_QUOTES)); ?>`, `<?php echo e(htmlspecialchars($contact->job_title ?? '', ENT_QUOTES)); ?>`, `<?php echo e(htmlspecialchars($contact->phone ?? '', ENT_QUOTES)); ?>`)" class="btn btn-sm btn-outline-primary rounded-circle shadow-sm hover-zoom d-flex align-items-center justify-content-center" style="width:32px; height:32px;" title="تعديل"><i class="fas fa-edit"></i></button>
                                    <form action="<?php echo e(route('contacts.destroy', $contact->id)); ?>" method="POST" class="m-0 p-0">
                                        <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
            ...
            <div class="card-body p-0 overflow-auto">
                <div class="table-responsive">
                    <table class="table table-borderless table-hover align-middle mb-0" id="tasksTable">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $displayTasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="border-bottom task-row" data-original-order="<?php echo e($index); ?>" data-priority="<?php echo e($task->priority == 'high' ? 3 : ($task->priority == 'medium' ? 2 : 1)); ?>" data-date="<?php echo e($task->deadline); ?>">
                                    <td class="px-4 py-3 fw-bold text-dark" style="max-width: 350px;">
                                        <div class="text-truncate"><?php echo e($task->task_desc); ?></div>
                                        <?php if($task->attachment_url): ?>
                                            <a href="<?php echo e($task->attachment_url); ?>" target="_blank" class="badge bg-light text-primary border text-decoration-none mt-2 d-inline-block hover-zoom">
                                                <i class="fas fa-paperclip me-1"></i> مرفق خارجي
                                            </a>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <?php if($task->priority == 'high'): ?> <span class="badge bg-danger bg-opacity-10 text-danger border border-danger rounded-pill px-3">عالية</span>
                                        <?php elseif($task->priority == 'medium'): ?> <span class="badge bg-warning bg-opacity-10 text-dark border border-warning rounded-pill px-3">متوسطة</span>
                                        <?php else: ?> <span class="badge bg-info bg-opacity-10 text-info border border-info rounded-pill px-3">عادية</span> <?php endif; ?>
                                    </td>
                                    <td dir="ltr" class="text-end text-muted small fw-bold"><i class="far fa-calendar me-1"></i> <?php echo e(\Carbon\Carbon::parse($task->deadline)->format('Y-m-d')); ?></td>
                                    <td>
                                        <div class="d-flex flex-wrap gap-1">
                                            <?php $__currentLoopData = $task->assignedUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <span class="badge bg-light text-dark border"><?php echo e($u->username); ?></span> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    <td class="text-center d-flex justify-content-center gap-1 border-0">
                                    <?php if($isAdminAuth): ?>
                                        <button type="button" onclick="openEditTaskModal(this)" data-id="<?php echo e($task->id); ?>" data-desc="<?php echo e(htmlspecialchars($task->task_desc, ENT_QUOTES)); ?>" data-deadline="<?php echo e($task->deadline); ?>" data-priority="<?php echo e($task->priority); ?>" data-client="<?php echo e($task->client_id); ?>" data-recurrence="<?php echo e($task->recurrence_type); ?>" data-recurrence-end="<?php echo e($task->recurrence_end_date); ?>" data-attachment="<?php echo e($task->attachment_url); ?>" data-users="<?php echo e(json_encode($task->assignedUsers->pluck('id'))); ?>" class="btn btn-sm btn-outline-primary rounded-circle shadow-sm hover-zoom" style="width:36px; height:36px;" title="تعديل المهمة">
                                            <i class="fas fa-edit"></i>
                                        </button>

                                        <form action="<?php echo e(route('tasks.destroy', $task->id)); ?>" method="POST" class="m-0 p-0">
                                            <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                    ...
                                    <button type="button" onclick="openCompleteModal(<?php echo e($task->id); ?>)" class="btn btn-sm btn-success rounded-circle shadow-sm hover-zoom" style="width:36px; height:36px;" title="إنجاز المهمة">
    ...
    <div class="tab-pane fade" id="documents" role="tabpanel">
        <div class="custom-card border-top border-danger border-4 p-4 h-100 overflow-auto">
            ...
            <div class="row g-3">
                <?php $__empty_1 = true; $__currentLoopData = $client->documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="col-md-4">
                        <div class="d-flex justify-content-between align-items-center bg-light border border-danger border-opacity-10 p-3 rounded-4 hover-zoom h-100 gap-2">
                            <span class="small fw-bold text-dark text-truncate" title="<?php echo e($doc->name); ?>"><i class="fas fa-file-pdf text-danger me-2 fs-4 align-middle"></i> <?php echo e($doc->name); ?></span>
                            <div class="d-flex align-items-center gap-1 flex-shrink-0">
                                <a href="<?php echo e($doc->drive_url); ?>" target="_blank" class="btn btn-sm btn-light text-danger rounded-circle shadow-sm d-flex align-items-center justify-content-center" style="width:32px; height:32px;" title="فتح الرابط"><i class="fas fa-external-link-alt"></i></a>
                                <button type="button" onclick="openEditDocModal(<?php echo e($doc->id); ?>, `<?php echo e(htmlspecialchars($doc->name, ENT_QUOTES)); ?>`, `<?php echo e(htmlspecialchars($doc->drive_url, ENT_QUOTES)); ?>`)" class="btn btn-sm btn-outline-primary rounded-circle shadow-sm hover-zoom d-flex align-items-center justify-content-center" style="width:32px; height:32px;" title="تعديل"><i class="fas fa-edit"></i></button>
                                <form action="<?php echo e(route('attachments.destroy', $doc->id)); ?>" method="POST" class="m-0 p-0">
                                    <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
    ...
    <div class="tab-pane fade" id="chat" role="tabpanel">
        <div class="chat-card">
            ...
            <div class="chat-header bg-white border-bottom pt-3 pb-3 px-4 shadow-sm" style="z-index:10;">
                <div class="d-flex justify-content-between align-items-center mb-2 flex-wrap gap-2">
                    <h5 class="fw-bold mb-0 text-dark">
                        ...
                        <?php echo e($isWorkspace ? 'شات فريق العمل' : 'سجل المتابعة والتفاعل'); ?>
                    ...
                    <div class="d-flex flex-wrap gap-2 align-items-center">
                        ...
                        <?php if($isAdminAuth): ?>
                            <form action="<?php echo e(route('operations.clear', $client->id)); ?>" method="POST" class="m-0 p-0">
                                <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
            ...
            <?php $pinnedMessages = $operations->where('is_pinned', true); ?>
            <?php if($pinnedMessages->count() > 0): ?>
            <div class="px-4 py-2 bg-white border-bottom shadow-sm d-flex align-items-center overflow-auto" style="white-space: nowrap; gap: 8px;">
                ...
                <?php $__currentLoopData = $pinnedMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button type="button" onclick="scrollToMsg(<?php echo e($pm->id); ?>)" class="btn btn-sm btn-light rounded-pill border border-warning border-opacity-50 shadow-sm hover-zoom px-3" style="max-width: 220px; text-overflow: ellipsis; overflow: hidden; white-space: nowrap; font-size: 0.8rem;">
                        <?php echo e(\Illuminate\Support\Str::limit(strip_tags($pm->action_text), 35)); ?>
            ...
            <div class="chat-container flex-grow-1 p-4" id="chatBox">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $operations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $op): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    ...
                    <?php if($currentDate !== $lastDate): ?>
                        <div class="chat-date-separator">
                            <?php if($currentDate == now()->format('Y-m-d')): ?> اليوم
                            <?php elseif($currentDate == now()->subDay()->format('Y-m-d')): ?> أمس
                            <?php else: ?> <?php echo e(\Carbon\Carbon::parse($currentDate)->format('d M Y')); ?> <?php endif; ?>
                        </div>
                        <?php $lastDate = $currentDate; ?>
                    <?php endif; ?>

                    <?php if($op->is_system): ?>
    <div id="msg-<?php echo e($op->id); ?>" class="d-flex justify-content-center w-100 my-2 chat-searchable" data-msg-id="<?php echo e($op->id); ?>">
        <span class="system-msg-line shadow-sm"><i class="fas fa-info-circle me-1 text-secondary"></i> <?php echo $op->formatted_text ?? strip_tags($op->action_text, '<b><i><u><strong><em><br><a><span>'); ?> <span class="ms-2 opacity-50" dir="ltr"><?php echo e($op->created_at->format('h:i A')); ?></span></span>
    </div>
<?php else: ?>
    <div id="msg-<?php echo e($op->id); ?>" class="chat-message chat-searchable d-flex align-items-start gap-3 w-100 mb-3 <?php echo e($isMe ? 'ms-auto flex-row-reverse' : ''); ?> <?php echo e($op->is_pinned ? 'msg-pinned' : ''); ?>" data-msg-id="<?php echo e($op->id); ?>">
        
        <div class="avatar shadow-sm mt-1 <?php echo e($isMe ? 'bg-avatar-mine' : 'bg-avatar-other'); ?>">
            <?php echo e(mb_substr($op->user->username ?? 'ن', 0, 2)); ?>

        </div>

                            <div class="chat-bubble shadow-sm <?php echo e($isMe ? 'bg-msg-mine' : 'bg-msg-other'); ?>">
                                <?php if($op->is_pinned): ?>
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-2 pb-1 border-bottom <?php echo e($isMe ? 'border-light border-opacity-25' : 'border-secondary border-opacity-10'); ?>">
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="fw-bold <?php echo e($isMe ? 'text-white' : 'text-primary'); ?>" style="font-size: 0.85rem;"><?php echo e($op->user->username ?? 'نظام'); ?></span>
                                        <span class="<?php echo e($isMe ? 'text-white-50' : 'text-muted'); ?>" style="font-size: 0.65rem;" dir="ltr"><?php echo e($op->created_at->format('h:i A')); ?></span>
                                    </div>
                                    
                                    <div class="dropdown ms-2">
                                        <button class="btn btn-sm p-0 shadow-none border-0 text-<?php echo e($isMe ? 'white' : 'muted'); ?> hover-zoom d-flex align-items-center justify-content-center" style="opacity: 0.8;" type="button" data-bs-toggle="dropdown"><i class="fas fa-ellipsis-v px-2"></i></button>
                                        <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 rounded-3" style="min-width: 120px; font-size: 0.9rem;">
                                            <li>
                                                <button type="button" class="dropdown-item text-primary fw-bold" onclick="prepareReply(<?php echo e($op->id); ?>, `<?php echo e(htmlspecialchars(\Illuminate\Support\Str::limit(strip_tags($op->action_text), 40), ENT_QUOTES)); ?>`)">
                                            ...
                                            <?php if($canEdit): ?>
                                            <li>
                                                <button type="button" class="dropdown-item text-success fw-bold" onclick="openEditMessageModal(<?php echo e($op->id); ?>, `<?php echo e(htmlspecialchars($op->action_text, ENT_QUOTES)); ?>`)"><i class="fas fa-edit me-2"></i> تعديل</button>
                                            </li>
                                            <?php endif; ?>
                                            <?php if($isAdminAuth): ?>
                                            <li>
                                                <form action="<?php echo e(route('operations.destroy', $op->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                ...
                                <?php if($op->replyTo): ?>
                                    <div onclick="scrollToMsg(<?php echo e($op->replyTo->id); ?>)" class="p-2 mb-2 rounded-2 hover-zoom" style="background: <?php echo e($isMe ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.03)'); ?>; font-size: 0.8rem; border-right: 3px solid <?php echo e($isMe ? 'var(--gold-color)' : 'var(--primary-color)'); ?> !important; cursor: pointer;">
                                        <strong class="<?php echo e($isMe ? 'text-warning' : 'text-primary'); ?> d-block mb-1"><i class="fas fa-reply me-1"></i> <?php echo e($op->replyTo->user->username ?? '---'); ?></strong>
                                        <span class="text-truncate d-block text-<?php echo e($isMe ? 'white-50' : 'muted'); ?>" style="max-width: 100%; opacity: 0.9;"><?php echo e(\Illuminate\Support\Str::limit(strip_tags($op->replyTo->action_text), 60)); ?></span>
                                    </div>
                                <?php endif; ?>

                                <div class="chat-content text-break" style="line-height: 1.6; font-size: 0.95rem;">
    <?php echo $op->formatted_text ?? nl2br(e($op->action_text)); ?>

</div>

                                <?php if($op->attachment_url): ?>
                                    <div class="mt-2">
                                        <a href="<?php echo e($op->attachment_url); ?>" target="_blank" class="btn btn-sm shadow-sm w-100 fw-bold hover-zoom <?php echo e($isMe ? 'bg-white text-primary border-0' : 'bg-light border text-dark'); ?> rounded-pill">
                                            <i class="fas fa-link me-1"></i> فتح الرابط المرفق
                                        </a>
                                    </div>
                                <?php endif; ?>

                                <div class="d-flex justify-content-between align-items-center mt-2 pt-1 border-top <?php echo e($isMe ? 'border-light border-opacity-10' : 'border-secondary border-opacity-10'); ?>">
                                    <div class="reactions-container d-flex flex-wrap gap-1 align-items-center">
                                        ...
                                        ?>
                                        <?php $__currentLoopData = $groupedReactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emoji => $reactions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php 
                                                $iReacted = $reactions->contains('user_id', auth()->id()); 
                                                $reactorsNames = $reactions->map(function($r) { return $r->user->username ?? 'نظام'; })->implode('، ');
                                            ?>
                                            <form action="<?php echo e(route('operations.react', $op->id)); ?>" method="POST" class="m-0 p-0">
                                                <?php echo csrf_field(); ?> <input type="hidden" name="emoji" value="<?php echo e($emoji); ?>">
                                                <button type="submit" class="badge rounded-pill border shadow-sm px-2 py-1 hover-zoom <?php echo e($iReacted ? 'bg-primary text-white border-primary' : 'bg-white text-dark border-light'); ?>" style="cursor:pointer; font-size:0.75rem;" title="<?php echo e($reactorsNames); ?>">
                                                    <?php echo e($emoji); ?> <?php echo e($reactions->count()); ?>
                                        ...
                                        <div class="dropup reactions-dropup">
                                            <button class="badge rounded-pill border text-muted shadow-sm px-2 py-1 hover-zoom <?php echo e($isMe ? 'bg-white bg-opacity-10 text-white border-light' : 'bg-white border-light'); ?>" style="cursor:pointer;" data-bs-toggle="dropdown" data-bs-auto-close="outside"><i class="far fa-smile"></i></button>
                                            <ul class="dropdown-menu dropdown-menu-start p-2 shadow-lg border-0 rounded-4" style="min-width: auto; background: rgba(255,255,255,0.98); backdrop-filter: blur(10px);">
                                                <li>
                                                    <div class="d-flex flex-row gap-1 px-1">
                                                        <?php $__currentLoopData = ['👍', '❤️', '✅', '😂', '👀']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <form action="<?php echo e(route('operations.react', $op->id)); ?>" method="POST" class="m-0 p-0">
                                                                <?php echo csrf_field(); ?> <input type="hidden" name="emoji" value="<?php echo e($e); ?>">
                                                                <button type="submit" class="btn btn-sm btn-light rounded-circle p-1 fs-5 d-flex align-items-center justify-content-center hover-zoom" style="width:38px; height:38px;"><?php echo e($e); ?></button>
                                                            </form>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </div>
                                                </li>
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <?php if($op->is_edited): ?> <small class="<?php echo e($isMe ? 'text-white-50' : 'text-muted'); ?>" style="font-size: 0.65rem;" title="تم التعديل"><i class="fas fa-pen"></i></small> <?php endif; ?>
                                        <?php if($canPin): ?>
                                            <form action="<?php echo e(route('operations.pin', $op->id)); ?>" method="POST" class="m-0 p-0">
                                                <?php echo csrf_field(); ?>
                                                <button type="submit" class="btn btn-sm p-0 border-0 bg-transparent <?php echo e($isMe ? 'text-white-50' : 'text-muted'); ?> hover-zoom" title="<?php echo e($op->is_pinned ? 'إلغاء التثبيت' : 'تثبيت كمرجع'); ?>"><i class="fas fa-thumbtack <?php echo e($op->is_pinned ? 'text-warning fs-6' : ''); ?>"></i></button>
                                            </form>
                                        <?php endif; ?>
                                    </div>
                                </div>
            ...
            <div class="chat-input-area p-3 px-4 sticky-bottom border-top">
                ...
                <form action="<?php echo e(route('operations.store', $client->id)); ?>" method="POST" id="chatSendMessageForm">
                    <?php echo csrf_field(); ?>
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" step="0.01" name="subscription_amount" value="<?php echo e($client->subscription_amount); ?>" class="form-control shadow-sm border-success" placeholder="مثال: 1500.00">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" name="sub_start_date" id="edit_start_date" value="<?php echo e(!empty($client->sub_start_date) ? \Carbon\Carbon::parse($client->sub_start_date)->format('Y-m-d') : ''); ?>" class="form-control shadow-sm border-light">
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="date" id="edit_end_date" name="sub_end_date" value="<?php echo e(!empty($client->sub_end_date) ? \Carbon\Carbon::parse($client->sub_end_date)->format('Y-m-d') : ''); ?>" class="form-control shadow-sm border-light bg-light" readonly>
                        </div>
                        <div class="col-md-12 border-top pt-3 mt-3">
                            <label class="form-label fw-bold text-primary mb-3"><i class="fas fa-eye me-1"></i> نطاق رؤية العميل</label>
                            <div class="d-flex flex-wrap gap-4 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input visibility-radio" type="radio" name="visibility" id="vis_all_show" value="all" <?php echo e($client->visibility == 'all' ? 'checked' : ''); ?>>
                                    <label class="form-check-label fw-bold text-success" for="vis_all_show">متاح للجميع</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input visibility-radio" type="radio" name="visibility" id="vis_specific_show" value="specific" <?php echo e($client->visibility == 'specific' ? 'checked' : ''); ?>>
                                    <label class="form-check-label fw-bold text-primary" for="vis_specific_show">تخصيص لموظفين محددين</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input visibility-radio" type="radio" name="visibility" id="vis_admins_show" value="admins_only" <?php echo e($client->visibility == 'admins_only' ? 'checked' : ''); ?>>
                                    <label class="form-check-label fw-bold text-danger" for="vis_admins_show">مغلق للإدارة فقط</label>
                                </div>
                            </div>
                            <div class="border rounded-4 p-3 bg-white shadow-sm employees-box" style="max-height: 150px; overflow-y: auto; <?php echo e($client->visibility == 'specific' ? 'display: block;' : 'display: none;'); ?>">
                                ...
                                <?php $__currentLoopData = \App\Models\User::where('role', '!=', 'admin')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="form-check mb-2 border-bottom pb-1">
                                        <input class="form-check-input" type="checkbox" name="assigned_users[]" value="<?php echo e($u->id); ?>" id="edit_u_<?php echo e($u->id); ?>_show" <?php echo e(in_array($u->id, $assignedUserIds) ? 'checked' : ''); ?>>
                                        <label class="form-check-label small text-dark fw-bold" for="edit_u_<?php echo e($u->id); ?>_show"><?php echo e($u->username); ?></label>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
...
<div class="modal fade" id="addDocModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <form action="<?php echo e(route('attachments.store', $client->id)); ?>" method="POST" class="modal-content rounded-4 border-0 shadow-lg">
            <?php echo csrf_field(); ?>
            <div class="modal-header bg-danger text-white border-0 py-3">
...
<div class="modal fade" id="addContactModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <form action="<?php echo e(route('contacts.store', $client->id)); ?>" method="POST" class="modal-content rounded-4 border-0 shadow-lg">
                <?php echo csrf_field(); ?>
...
<div class="modal fade" id="addNoteModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <form action="<?php echo e(route('notes.store', $client->id)); ?>" method="POST" class="modal-content rounded-4 border-0 shadow-lg">
                <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\crm\accounting-crm\resources\views/clients/show.blade.php ENDPATH**/ ?>